...
public class UserListBench
{
    ...
    private static readonly EachReader<User> _parser = HandXml.Default.Entity<User>()
        .WithItem<int>(nameof(User.Id))
        .WithItem(nameof(User.Name))
        .WithItem<int>(nameof(User.Age))
        .Element(nameof(User))
        .Each();
    private static readonly EachReader<User> _parser1 = HandXml.Default.Entity<User, UserBuilder>()
        .WithItem<int>(nameof(User.Id))
        .WithItem(nameof(User.Name))
        .WithItem<int>(nameof(User.Age))
        .Element(nameof(User))
        .Each();
    private static readonly EachReader<User> _parser2 = HandXml.Default.Entity(UserBuilder.Creater)
        .WithItem<int>(nameof(User.Id))
        .WithItem(nameof(User.Name))
        .WithItem<int>(nameof(User.Age))
        .Element(nameof(User))
        .Each();
    private static readonly EachReader<User> _parser3 = HandXml.Default.Entity(UserBuilder2.Creater)
        .WithItem<int>(nameof(User.Id))
        .WithItem(nameof(User.Name))
        .WithItem<int>(nameof(User.Age))
        .Element(nameof(User))
